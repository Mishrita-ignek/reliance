                  ...
                  <nav class="ig-nav_colmn2">
                     <div class="ig-nav_subcolmn1">
                        <ul id="nav">
                           ...
                           <li class="ig-top">
                              ...
                              <ul class="ig-sub">
                                 <li>
                                    ...
                                    <ul class='ig-nested'>
                                       <li><a href="/web/reliance-power/company-overview">Business Details</a></li>
                                       <li><button class='toggle-nested-menu'>+</button><a href="/web/reliance-power/financials">Financials</a>
                                 ...
                                 <li>
                                    <button class='toggle-nested-menu'>+</button>
                                    <a href="#">Investor Communication</a>
                                    <img src="/o/Reliance-Group-India-Theme/images/navigation/right-arrow.png" alt="Icon"
                                       style="width:15px; height:15px; vertical-align:middle; margin-right:8px;
                                       position: absolute;top: 15px;right: 0;">
                                    <ul class='ig-nested'>
                                       <li><a href="/web/reliance-power/extraordinary-general-meeting"><span>Extraordinary General Meeting</span></a></li>
                                       <li><a href="/web/reliance-power/postal-ballot-notice-and-result"><span>Postal Ballot-Notice &amp; Result</span></a></li>
                                    </ul>
                                 </li>
                                 <li><a href="/web/reliance-power/shareholder-services"><span>Shareholder Services</span></a></li>
                                 <li><a href="/web/reliance-power/shareholder-registration"><span>Shareholder Registration</span></a></li>
                           ...
                           <li class="ig-top">
                              <button class='toggle-submenu'>+</button>
                              <a href="#" class="ig-top_link" id="t05">Procurement</a>
                              <ul class="ig-sub">
                           ...
                           <li class="ig-top">
                              <button class='toggle-submenu'>+</button>
                              <a href="#" class="ig-top_link" id="t05">Media</a>
                              <ul class="ig-sub">
                           ...
                           <li class="ig-top">
                              <button class='toggle-submenu'>+</button>
                              <a href="/web/reliance-power/contact-us" class="ig-top_link" id="t10">Contact Us</a>
                              <ul class="ig-sub">
                                <li><a href="/web/reliance-power/registered-office">Registered Office</a></li>
                              </ul>
                           </li>
                        </ul>
                     </div>
