...
<div class="fright ">
  ...
  <div class="LogoText ">Engineering, Procurement & Construction</div>
...
<select class="group_select" name="select" size="1" style="font-family:Arial; font-size:11px; color:#666; width:195px; padding:0; margin:-8px 0; #margin:-15px 0px 0px -10px !important;" onChange="if(options[selectedIndex].value)window.open(options[selectedIndex].value,'_blank')">
