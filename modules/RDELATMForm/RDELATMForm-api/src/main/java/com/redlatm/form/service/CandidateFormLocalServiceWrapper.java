...
/**
 * Provides a wrapper for {@link CandidateFormLocalService}.
 *
 * @author Mukesh,Vipin
 ...
 */
@ProviderType
public class CandidateFormLocalServiceWrapper
	implements CandidateFormLocalService,
		ServiceWrapper<CandidateFormLocalService> {
	public CandidateFormLocalServiceWrapper(
		CandidateFormLocalService candidateFormLocalService) {
		_candidateFormLocalService = candidateFormLocalService;
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.ActionableDynamicQuery getActionableDynamicQuery() {
		return _candidateFormLocalService.getActionableDynamicQuery();
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery() {
		return _candidateFormLocalService.dynamicQuery();
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		return _candidateFormLocalService.getIndexableActionableDynamicQuery();
	}
	...
	*/
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _candidateFormLocalService.deletePersistedModel(persistedModel);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return _candidateFormLocalService.getPersistedModel(primaryKeyObj);
	}
	...
	*/
	@Override
	public com.redlatm.form.model.CandidateForm addCandidateForm(
		com.redlatm.form.model.CandidateForm candidateForm) {
		return _candidateFormLocalService.addCandidateForm(candidateForm);
	}
	...
	*/
	@Override
	public com.redlatm.form.model.CandidateForm createCandidateForm(long CaId) {
		return _candidateFormLocalService.createCandidateForm(CaId);
	}
	...
	*/
	@Override
	public com.redlatm.form.model.CandidateForm deleteCandidateForm(
		com.redlatm.form.model.CandidateForm candidateForm) {
		return _candidateFormLocalService.deleteCandidateForm(candidateForm);
	}
	...
	*/
	@Override
	public com.redlatm.form.model.CandidateForm deleteCandidateForm(long CaId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _candidateFormLocalService.deleteCandidateForm(CaId);
	}

	@Override
	public com.redlatm.form.model.CandidateForm fetchCandidateForm(long CaId) {
		return _candidateFormLocalService.fetchCandidateForm(CaId);
	}
	...
	*/
	@Override
	public com.redlatm.form.model.CandidateForm getCandidateForm(long CaId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _candidateFormLocalService.getCandidateForm(CaId);
	}
	...
	*/
	@Override
	public com.redlatm.form.model.CandidateForm updateCandidateForm(
		com.redlatm.form.model.CandidateForm candidateForm) {
		return _candidateFormLocalService.updateCandidateForm(candidateForm);
	}
	...
	*/
	...
	public int getCandidateFormsCount() {
		return _candidateFormLocalService.getCandidateFormsCount();
	}
	...
	public java.lang.Long saveCandidateForm(java.lang.Long caId,
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return _candidateFormLocalService.saveCandidateForm(caId, name,
			surname, fatherOrSpouse, AadharNo, panNumber, BankAcNo,
			EmpExResgnNo, dob, NativeLoc, motherTongue, identificationMark,
			domicile, languagesKnown, Company, location, Role, fromEx, toEx,
			reasonLeaving, ph_State, religion, caste, subCast, mrtOption,
			ableToJoin, npMonth, npDays, Address, city, InState, pinNumber,
			emailId, AlEmailId, mobNumberber, AlMobNumberber, ALPersonName,
			mainQualification, specialization, trade, totalExp, skillLevel,
			scFrom, ScvalidTill, docName, docAddres, docRegnNo, mFvalidTill,
			CEaddress, cCompany, workingSince, designation, ctcFixed,
			ctcVariable, ctcTotal, role, Location, npDuration,
			f_company_name_1, f_from_1, f_to_1, f_location_1, f_designation_1,
			f_ctc_fixed_1, f_ctc_variable_1, f_ctc_total_1, f_remark_1,
			f_company_name_2, f_from_2, f_to_2, f_location_2, f_designation_2,
			f_ctc_fixed_2, f_ctc_variable_2, f_ctc_total_2, f_remark_2,
			f_company_name_3, f_from_3, f_to_3, f_location_3, f_designation_3,
			f_ctc_fixed_3, f_ctc_variable_3, f_ctc_total_3, f_remark_3,
			f_company_name_4, f_from_4, f_to_4, f_location_4, f_designation_4,
			f_ctc_fixed_4, f_ctc_variable_4, f_ctc_total_4, f_remark_4,
			f_company_name_5, f_from_5, f_to_5, f_location_5, f_designation_5,
			f_ctc_fixed_5, f_ctc_variable_5, f_ctc_total_5, f_remark_5,
			f_qualification_1, f_Institute_1, f_year_1, f_grade_1,
			f_qualification_2, f_Institute_2, f_year_2, f_grade_2,
			f_qualification_3, f_Institute_3, f_year_3, f_grade_3,
	...
	public java.lang.String getCandidateEmailId(java.lang.String email) {
		return _candidateFormLocalService.getCandidateEmailId(email);
	}
	...
	*/
	...
	public java.lang.String getOSGiServiceIdentifier() {
		return _candidateFormLocalService.getOSGiServiceIdentifier();
	}

	@Override
	public java.lang.String saveCandidateRegistrationForm(
		com.redlatm.form.model.CandidateForm candidateRegistrationForm) {
		return _candidateFormLocalService.saveCandidateRegistrationForm(candidateRegistrationForm);
	}
	...
	public java.lang.String setCandidatePasswordServiceImpl(
		...
		return _candidateFormLocalService.setCandidatePasswordServiceImpl(oldpassword,
			password, emailId);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _candidateFormLocalService.dynamicQuery(dynamicQuery);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		int end) {
		return _candidateFormLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _candidateFormLocalService.dynamicQuery(dynamicQuery, start,
			end, orderByComparator);
	}

	@Override
	public java.util.List<com.redlatm.form.model.CandidateForm> findCandidateEmailId(
		java.lang.String emailAddress) {
		return _candidateFormLocalService.findCandidateEmailId(emailAddress);
	}
	...
	*/
	@Override
	public java.util.List<com.redlatm.form.model.CandidateForm> getCandidateForms(
		int start, int end) {
		return _candidateFormLocalService.getCandidateForms(start, end);
	}

	@Override
	public java.util.List<com.redlatm.form.model.CandidateForm> getValidateCandidateEmailServiceImpl(
		java.lang.String email) {
		return _candidateFormLocalService.getValidateCandidateEmailServiceImpl(email);
	}

	@Override
	public java.util.List validateUserLoginService(java.lang.String username,
		java.lang.String password) {
		return _candidateFormLocalService.validateUserLoginService(username,
			password);
	}

	@Override
	public java.util.List<com.redlatm.form.model.CandidateForm> viewCandidateProfile(
		java.lang.String email) {
		return _candidateFormLocalService.viewCandidateProfile(email);
	}
	...
	*/
	...
	public long dynamicQueryCount(
		com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery) {
		return _candidateFormLocalService.dynamicQueryCount(dynamicQuery);
	}
	...
	*/
	...
	@Override
	public void test() {
		_candidateFormLocalService.test();
	}

	@Override
	public CandidateFormLocalService getWrappedService() {
		return _candidateFormLocalService;
	}
	...
	private CandidateFormLocalService _candidateFormLocalService;
}