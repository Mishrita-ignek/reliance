...
public class MailSend
{
  ...
  public static String smtpserver="10.8.49.43"; 
  //public static String smtpserver="10.8.55.80";  
  //public static String smtpserver="10.8.53.82"; 
  public static String complaintmailmsg="Reliance Infrastructure";
  
 /* static
  {
    PropertyResourceBundle lPortalBundle = (PropertyResourceBundle)ResourceBundle.getBundle("com.video.Portal");
    //smtpserver = lPortalBundle.handleGetObject("smtpserver").toString();
    //complaintmailmsg = lPortalBundle.handleGetObject("complaintmailmsg").toString();
  ...
  public boolean sendMail(String Subject, String message, String tomailid, String frommailid)
  {
    ...
    {
      this.to = tomailid;
      this.bcc = "Mukesh.Patidar@relianceada.com,Vipin.K.Singh@relianceada.com";
  ...
  public boolean contactusmail(String Subject, String message, String tomailid, String ccmailid, String bccmailid, String frommailid)
  {
    boolean flag = false;
    try
    {
  ...
  public boolean contactusmail1(String Subject, String message, String tomailid, String ccmailid, String bccmailid, String frommailid)
  {
    boolean flag = false;
    try
    {
