...
/**
 * Provides the local service interface for MediaQuery. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MediaQueryLocalServiceUtil
...
public interface MediaQueryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MediaQueryLocalServiceUtil} to access the media query local service. Add custom service methods to {@link com.media.query.service.impl.MediaQueryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MediaQuery addMediaQuery(MediaQuery mediaQuery);
	...
	*/
	public MediaQuery createMediaQuery(long srNo);
	...
	*/
	...
	public MediaQuery deleteMediaQuery(MediaQuery mediaQuery);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MediaQuery deleteMediaQuery(long srNo) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MediaQuery fetchMediaQuery(long srNo);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MediaQuery getMediaQuery(long srNo) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MediaQuery updateMediaQuery(MediaQuery mediaQuery);
	...
	*/
	...
	public java.lang.String saveMediaQuery(MediaQuery mediaQuery);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MediaQuery> getMediaQueries(int start, int end);
