...
/**
 * Provides the local service interface for AttendenceTransaction. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AttendenceTransactionLocalServiceUtil
...
public interface AttendenceTransactionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AttendenceTransactionLocalServiceUtil} to access the attendence transaction local service. Add custom service methods to {@link attendence.rinfra.services.service.impl.AttendenceTransactionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public AttendenceTransaction createAttendenceTransaction(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AttendenceTransaction deleteAttendenceTransaction(
		java.lang.String srNo) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttendenceTransaction fetchAttendenceTransaction(
		java.lang.String srNo);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttendenceTransaction getAttendenceTransaction(java.lang.String srNo)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AttendenceTransaction> getAttendenceTrann(
		java.lang.String code, java.lang.String date);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AttendenceTransaction> getAttendenceTrann(java.lang.String date);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AttendenceTransaction> getEmp(java.lang.String code);
