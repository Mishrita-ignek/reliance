...
/**
 * Provides the local service interface for EmpMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmpMasterLocalServiceUtil
...
public interface EmpMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmpMasterLocalServiceUtil} to access the emp master local service. Add custom service methods to {@link attendence.rinfra.services.service.impl.EmpMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public EmpMaster createEmpMaster(java.lang.String employeeCode);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public EmpMaster deleteEmpMaster(java.lang.String employeeCode)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmpMaster fetchEmpMaster(java.lang.String employeeCode);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmpMaster getEmpMaster(java.lang.String employeeCode)
		throws PortalException;
