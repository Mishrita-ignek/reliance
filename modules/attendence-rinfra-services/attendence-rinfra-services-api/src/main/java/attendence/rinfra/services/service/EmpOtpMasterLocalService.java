...
/**
 * Provides the local service interface for EmpOtpMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmpOtpMasterLocalServiceUtil
...
public interface EmpOtpMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmpOtpMasterLocalServiceUtil} to access the emp otp master local service. Add custom service methods to {@link attendence.rinfra.services.service.impl.EmpOtpMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public EmpOtpMaster addEmpOtpMaster(EmpOtpMaster empOtpMaster);
	...
	*/
	public EmpOtpMaster createEmpOtpMaster(java.lang.String empMobile);
	...
	*/
	...
	public EmpOtpMaster deleteEmpOtpMaster(EmpOtpMaster empOtpMaster);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public EmpOtpMaster deleteEmpOtpMaster(java.lang.String empMobile)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmpOtpMaster fetchEmpOtpMaster(java.lang.String empMobile);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmpOtpMaster getEmpOtpMaster(java.lang.String empMobile)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public EmpOtpMaster updateEmpOtpMaster(EmpOtpMaster empOtpMaster);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EmpOtpMaster> getEmpOtpMasters(int start, int end);
