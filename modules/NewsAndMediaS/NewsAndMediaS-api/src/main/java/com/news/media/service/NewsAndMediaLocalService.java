...
/**
 * Provides the local service interface for NewsAndMedia. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NewsAndMediaLocalServiceUtil
...
public interface NewsAndMediaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NewsAndMediaLocalServiceUtil} to access the news and media local service. Add custom service methods to {@link com.news.media.service.impl.NewsAndMediaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NewsAndMedia> getNewsList(java.lang.String monthYear,
		java.lang.String publication);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NewsAndMedia> getPublicationList(java.lang.String monthYear);
