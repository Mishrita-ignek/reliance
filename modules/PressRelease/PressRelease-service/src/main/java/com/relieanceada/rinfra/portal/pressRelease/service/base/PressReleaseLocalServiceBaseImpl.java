...
/**
 * Provides the base implementation for the press release local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.relieanceada.rinfra.portal.pressRelease.service.impl.PressReleaseLocalServiceImpl}.
 * </p>
 *
 * @author Vipin Singh
...
public abstract class PressReleaseLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.relieanceada.rinfra.portal.pressRelease.service.PressReleaseLocalServiceUtil} to access the press release local service.
	 */
	...
	public PressRelease createPressRelease(long pressId) {
		return pressReleasePersistence.create(pressId);
	}
	...
	public PressRelease deletePressRelease(long pressId)
		...
		return pressReleasePersistence.remove(pressId);
	}
	...
	public PressRelease fetchPressRelease(long pressId) {
		return pressReleasePersistence.fetchByPrimaryKey(pressId);
	}
	...
	public PressRelease getPressRelease(long pressId) throws PortalException {
		return pressReleasePersistence.findByPrimaryKey(pressId);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.relieanceada.rinfra.portal.pressRelease.model.PressRelease",
