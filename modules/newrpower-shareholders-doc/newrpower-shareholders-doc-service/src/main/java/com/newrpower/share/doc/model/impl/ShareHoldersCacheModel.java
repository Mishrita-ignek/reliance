...
public class ShareHoldersCacheModel implements CacheModel<ShareHolders>,
	...
	public boolean equals(Object obj) {
		...
		if (FOLIO_NO.equals(shareHoldersCacheModel.FOLIO_NO)) {
			return true;
		}
	...
	public ShareHolders toEntityModel() {
		...
		shareHoldersImpl.setSRNO(SRNO);

		if (FOLIO_NO == null) {
			shareHoldersImpl.setFOLIO_NO(StringPool.BLANK);
		}
		else {
			shareHoldersImpl.setFOLIO_NO(FOLIO_NO);
		}

		if (SHARES == null) {
			shareHoldersImpl.setSHARES(StringPool.BLANK);
		}
		else {
			shareHoldersImpl.setSHARES(SHARES);
		}
