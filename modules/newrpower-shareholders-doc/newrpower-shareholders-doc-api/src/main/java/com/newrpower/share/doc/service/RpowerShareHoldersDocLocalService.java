...
/**
 * Provides the local service interface for RpowerShareHoldersDoc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RpowerShareHoldersDocLocalServiceUtil
...
public interface RpowerShareHoldersDocLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RpowerShareHoldersDocLocalServiceUtil} to access the rpower share holders doc local service. Add custom service methods to {@link com.newrpower.share.doc.service.impl.RpowerShareHoldersDocLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
