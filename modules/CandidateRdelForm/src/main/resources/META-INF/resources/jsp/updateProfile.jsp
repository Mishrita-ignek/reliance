...
<div class="panel panel-primary">
      ...
      <div class="col-sm-8">
        <%-- <textarea type="text" class="form-control" rows="3" id="Address" value="<%=applicationForm.getAddress()%>"  > </textarea> --%>
...
<th>% / Grade</th>
  ...
  <tbody>
    <tr>
<td>1</td>
<td><input value="<%=applicationForm.getSSCQualification()%>" class="form-control input-sm" type="text" value="SSC (10th)" readonly=""></td>
...
<td><input value="<%=applicationForm.getSSCGrade()%>" class="form-control input-sm" type="text"></td>
      ...
      <tr>
<td>2</td>
<td><input value="<%=applicationForm.getHSCQualification()%>" class="form-control input-sm" type="text" value="HSC (12th)" readonly=""></td>
...
<td><input value="<%=applicationForm.getHSCGrade()%>" class="form-control input-sm" type="text"></td>
    ...
    <tr>
<td>3</td>
<td><input value="<%=applicationForm.getGradQualification()%>" class="form-control input-sm" type="text" value="Basic/Graduation" readonly=""></td>
...
<td><input value="<%=applicationForm.getGradGrade()%>" class="form-control input-sm" type="text"></td>
    ...
    <tr>
<td>4</td>
<td><input value="<%=applicationForm.getPGQualification()%>" class="form-control input-sm" type="text" value="Post Graduation" readonly=""></td>
...
<td><input value="<%=applicationForm.getPGGrade()%>" class="form-control input-sm" type="text"></td>
  ...
  <tr>
<td>5</td>
<td><input value="<%=applicationForm.getOther1Qualification()%>" class="form-control input-sm" type="text" value="Doctorate/Ph.D."></td>
