...
import TestDoc.model.FooModel;
import TestDoc.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(TestDoc.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.TestDoc.model.Foo"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(TestDoc.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.TestDoc.model.Foo"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(TestDoc.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.TestDoc.model.Foo"), true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(TestDoc.service.util.ServiceProps.get(
				"lock.expiration.time.TestDoc.model.Foo"));
