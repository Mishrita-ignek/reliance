...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	@Override
	public TestDoc.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public TestDoc.model.Foo toUnescapedModel() {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<TestDoc.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public int compareTo(TestDoc.model.Foo foo) {
