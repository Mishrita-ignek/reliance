 ...
 * @see FooModel
 * @see TestDoc.model.impl.FooImpl
 * @see TestDoc.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("TestDoc.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link TestDoc.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
