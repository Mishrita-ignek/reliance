...
/**
 * Provides the local service interface for RelianceReality. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RelianceRealityLocalServiceUtil
...
public interface RelianceRealityLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RelianceRealityLocalServiceUtil} to access the reliance reality local service. Add custom service methods to {@link com.reliance.reality.service.impl.RelianceRealityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RelianceReality> getExistRecord(java.lang.String empCode,
