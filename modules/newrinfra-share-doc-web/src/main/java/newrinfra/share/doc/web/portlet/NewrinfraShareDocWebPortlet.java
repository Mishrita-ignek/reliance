package newrinfra.share.doc.web.portlet;
...
import com.newrpower.share.doc.service.ShareHoldersLocalServiceUtil;

import newrinfra.share.doc.web.constants.NewrinfraShareDocWebPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=newrinfra-share-doc-web Portlet",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + NewrinfraShareDocWebPortletKeys.NewrinfraShareDocWeb,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class NewrinfraShareDocWebPortlet extends MVCPortlet {
	
private static Log log = LogFactoryUtil.getLog(NewrinfraShareDocWebPortlet.class);
...
//			List<UnpaidUnclaimedDevidend> unpaidUnclaimedDevidendRecords = UnpaidUnclaimedDevidendLocalServiceUtil.getUnpaidUnclaimedDevidendData(folioNo);
//			log.info("getFOLIO_NO()----------" + unpaidUnclaimedDevidendRecords);
//			List<RinfraShareHolders> shareHolders = (List<RinfraShareHolders>) RinfraShareHoldersLocalServiceUtil.getShareHolder(folioNo);
			
			String no = shareHolders.getFOLIO_NO();
//			for(RinfraShareHolders holders : shareHolders){
...
//			}
			...
			if(folioNo.equals(no)){
				...
				//docList = RinfraShareHoldersDocLocalServiceUtil.getRinfraDocList();
