package com.rinfra.unpaid.unclaimed.devidend.portlet;
...
import com.rinfra.unpaid.unclaimed.devidend.service.UnpaidUnclaimedDevidendLocalServiceUtil;

/**
 * @author BO00136
 */
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		"com.liferay.portlet.instanceable=true", "javax.portlet.display-name=UnpaidUnclaimedDividend-web Portlet",
		"javax.portlet.init-param.template-path=/", "javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user" }, service = Portlet.class)
public class UnpaidUnclaimedDividendWebPortlet extends MVCPortlet {
	...
	public void getUnpaidDividendHolders(ActionRequest actionRequest, ActionResponse actionResponse) {
		try {
			...
			List<UnpaidUnclaimedDevidend> unpaidUnclaimedDevidendRecords = UnpaidUnclaimedDevidendLocalServiceUtil.getUnpaidUnclaimedDevidendData(FOLIO_NO_OF_ITIES);
