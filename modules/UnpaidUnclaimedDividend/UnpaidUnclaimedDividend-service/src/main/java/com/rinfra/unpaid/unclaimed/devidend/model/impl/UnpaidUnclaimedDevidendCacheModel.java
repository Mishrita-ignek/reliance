...
public class UnpaidUnclaimedDevidendCacheModel implements CacheModel<UnpaidUnclaimedDevidend>,
	...
	public UnpaidUnclaimedDevidend toEntityModel() {
		...
		if (FIRST_NAME == null) {
			unpaidUnclaimedDevidendImpl.setFIRST_NAME(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setFIRST_NAME(FIRST_NAME);
		}

		if (MIDDLE_NAME == null) {
			unpaidUnclaimedDevidendImpl.setMIDDLE_NAME(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setMIDDLE_NAME(MIDDLE_NAME);
		}

		if (LAST_NAME == null) {
			unpaidUnclaimedDevidendImpl.setLAST_NAME(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setLAST_NAME(LAST_NAME);
		}

		if (FATHER_HUSBAND_FIRST_NAME == null) {
			unpaidUnclaimedDevidendImpl.setFATHER_HUSBAND_FIRST_NAME(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setFATHER_HUSBAND_FIRST_NAME(FATHER_HUSBAND_FIRST_NAME);
		}

		if (FATHER_HUSBAND_MIDDLE_NAME == null) {
			unpaidUnclaimedDevidendImpl.setFATHER_HUSBAND_MIDDLE_NAME(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setFATHER_HUSBAND_MIDDLE_NAME(FATHER_HUSBAND_MIDDLE_NAME);
		}

		if (FATHER_HUSBAND_LAST_NAME == null) {
			unpaidUnclaimedDevidendImpl.setFATHER_HUSBAND_LAST_NAME(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setFATHER_HUSBAND_LAST_NAME(FATHER_HUSBAND_LAST_NAME);
		}

		if (ADDRESS == null) {
			unpaidUnclaimedDevidendImpl.setADDRESS(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setADDRESS(ADDRESS);
		}

		if (COUNTRY == null) {
			unpaidUnclaimedDevidendImpl.setCOUNTRY(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setCOUNTRY(COUNTRY);
		}

		if (STATE == null) {
			unpaidUnclaimedDevidendImpl.setSTATE(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setSTATE(STATE);
		}

		if (DISTRICT == null) {
			unpaidUnclaimedDevidendImpl.setDISTRICT(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setDISTRICT(DISTRICT);
		}

		unpaidUnclaimedDevidendImpl.setPIN_CODE(PIN_CODE);

		if (FOLIO_NO_OF_ITIES == null) {
			unpaidUnclaimedDevidendImpl.setFOLIO_NO_OF_ITIES(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setFOLIO_NO_OF_ITIES(FOLIO_NO_OF_ITIES);
		}

		if (INVESTMENT_TYPE == null) {
			unpaidUnclaimedDevidendImpl.setINVESTMENT_TYPE(StringPool.BLANK);
		}
		else {
			unpaidUnclaimedDevidendImpl.setINVESTMENT_TYPE(INVESTMENT_TYPE);
		}

		unpaidUnclaimedDevidendImpl.setAMOUNT_DUE_IN_RS(AMOUNT_DUE_IN_RS);

		if (PROPOSED_DATE_TRANSFER_IPEF == Long.MIN_VALUE) {
			unpaidUnclaimedDevidendImpl.setPROPOSED_DATE_TRANSFER_IPEF(null);
		}
		else {
			unpaidUnclaimedDevidendImpl.setPROPOSED_DATE_TRANSFER_IPEF(new Date(
					PROPOSED_DATE_TRANSFER_IPEF));
		}

		if (CREATEDATE == Long.MIN_VALUE) {
			unpaidUnclaimedDevidendImpl.setCREATEDATE(null);
		}
		else {
			unpaidUnclaimedDevidendImpl.setCREATEDATE(new Date(CREATEDATE));
		}
