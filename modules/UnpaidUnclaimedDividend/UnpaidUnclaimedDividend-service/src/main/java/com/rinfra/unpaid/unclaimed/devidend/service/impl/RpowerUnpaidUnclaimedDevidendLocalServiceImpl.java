...
import com.rinfra.unpaid.unclaimed.devidend.service.base.RpowerUnpaidUnclaimedDevidendLocalServiceBaseImpl;

/**
 * The implementation of the rpower unpaid unclaimed devidend local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.rinfra.unpaid.unclaimed.devidend.service.RpowerUnpaidUnclaimedDevidendLocalService} interface.
 *
 * <p>
...
public class RpowerUnpaidUnclaimedDevidendLocalServiceImpl
	...
	public List<RpowerUnpaidUnclaimedDevidend> getUnpaidUnclaimedDevidendDataNew(String FOLIO_NO_OF_ITIES)
	  {
		System.out.println("RpowerUserUnpaidUnclaimedDevidendLocalServiceImpl.getUnpaidUnclaimedDevidendData()");
	  List<RpowerUnpaidUnclaimedDevidend> devidendsRecords = this.rpowerUnpaidUnclaimedDevidendFinder.getUnpaidUnclaimedDevidendNew(FOLIO_NO_OF_ITIES);
