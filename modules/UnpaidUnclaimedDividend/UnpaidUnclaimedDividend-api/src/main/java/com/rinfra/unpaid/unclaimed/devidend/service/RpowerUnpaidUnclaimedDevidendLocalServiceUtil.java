 ...
 * {@link com.rinfra.unpaid.unclaimed.devidend.service.impl.RpowerUnpaidUnclaimedDevidendLocalServiceImpl} and is the
 ...
 * @see com.rinfra.unpaid.unclaimed.devidend.service.base.RpowerUnpaidUnclaimedDevidendLocalServiceBaseImpl
...
public class RpowerUnpaidUnclaimedDevidendLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.rinfra.unpaid.unclaimed.devidend.service.impl.RpowerUnpaidUnclaimedDevidendLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend addRpowerUnpaidUnclaimedDevidend(
		com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend rpowerUnpaidUnclaimedDevidend) {
		return getService()
	...
	*/
	public static com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend createRpowerUnpaidUnclaimedDevidend(
		long SRNO) {
	...
	*/
	public static com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend deleteRpowerUnpaidUnclaimedDevidend(
		com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend rpowerUnpaidUnclaimedDevidend) {
		return getService()
	...
	*/
	...
	public static com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend fetchRpowerUnpaidUnclaimedDevidend(
		long SRNO) {
	...
	* @throws PortalException if a rpower unpaid unclaimed devidend with the primary key could not be found
	*/
	public static com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend getRpowerUnpaidUnclaimedDevidend(
		long SRNO) throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend updateRpowerUnpaidUnclaimedDevidend(
		com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend rpowerUnpaidUnclaimedDevidend) {
		return getService()
	...
	*/
	public static java.util.List<com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend> getRpowerUnpaidUnclaimedDevidends(
		int start, int end) {
		return getService().getRpowerUnpaidUnclaimedDevidends(start, end);
	}

	public static java.util.List<com.rinfra.unpaid.unclaimed.devidend.model.RpowerUnpaidUnclaimedDevidend> getUnpaidUnclaimedDevidendDataNew(
		java.lang.String FOLIO_NO_OF_ITIES) {
		return getService().getUnpaidUnclaimedDevidendDataNew(FOLIO_NO_OF_ITIES);
	}
