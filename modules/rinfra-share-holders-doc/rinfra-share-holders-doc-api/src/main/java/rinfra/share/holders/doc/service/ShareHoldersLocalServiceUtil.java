 ...
 * {@link rinfra.share.holders.doc.service.impl.ShareHoldersLocalServiceImpl} and is the
 ...
 * @see rinfra.share.holders.doc.service.base.ShareHoldersLocalServiceBaseImpl
...
public class ShareHoldersLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link rinfra.share.holders.doc.service.impl.ShareHoldersLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static java.util.List<rinfra.share.holders.doc.model.ShareHolders> getShareHolder(
		java.lang.String no) {
		return getService().getShareHolder(no);
	}
	...
	*/
	public static java.util.List<rinfra.share.holders.doc.model.ShareHolders> getShareHolderses(
		int start, int end) {
	...
	*/
	public static rinfra.share.holders.doc.model.ShareHolders addShareHolders(
	...
	*/
	public static rinfra.share.holders.doc.model.ShareHolders createShareHolders(
		java.lang.String FOLIO_NO) {
		return getService().createShareHolders(FOLIO_NO);
	}
	...
	*/
	public static rinfra.share.holders.doc.model.ShareHolders deleteShareHolders(
		java.lang.String FOLIO_NO)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteShareHolders(FOLIO_NO);
	}
	...
	*/
	...
	public static rinfra.share.holders.doc.model.ShareHolders fetchShareHolders(
		java.lang.String FOLIO_NO) {
		return getService().fetchShareHolders(FOLIO_NO);
	}
	...
	* @throws PortalException if a share holders with the primary key could not be found
	*/
	public static rinfra.share.holders.doc.model.ShareHolders getShareHolders(
		java.lang.String FOLIO_NO)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getShareHolders(FOLIO_NO);
	}
	...
	*/
	public static rinfra.share.holders.doc.model.ShareHolders updateShareHolders(
		rinfra.share.holders.doc.model.ShareHolders shareHolders) {
