	...
	<a class="btn btn-primary" style="float:right;" href="<%=view.toString()%>">View</a>
		...
		<form action="<%=mailSendUrl%>" method="post">
			...
			<div class="form-group">
				 ...
				 <tr><td><input type="radio" name="<portlet:namespace/>listName" value="MMOPL Group"  onclick="getList();">MMOPL Group </td></tr>
				 <%-- <tr><td><input type="radio" name="<portlet:namespace/>listName" value="CEOMSG"  onclick="getList();">CEOMSG </td></tr> --%>
