...
/**
 * The persistence interface for the occ new service.
 *
 * <p>
 ...
 */
@ProviderType
public interface OccNewPersistence extends BasePersistence<OccNew> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OccNewUtil} to access the occ new persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<OccNew> occNews);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, OccNew> fetchByPrimaryKeys(
	...
	* @return the occ news
	*/
	public java.util.List<OccNew> findAll();
	...
	*/
	public java.util.List<OccNew> findAll(int start, int end);
	...
	*/
	public java.util.List<OccNew> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OccNew> orderByComparator);
