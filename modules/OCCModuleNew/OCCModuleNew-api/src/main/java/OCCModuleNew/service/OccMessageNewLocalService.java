...
/**
 * Provides the local service interface for OccMessageNew. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mukesh Patidar
 * @see OccMessageNewLocalServiceUtil
...
public interface OccMessageNewLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OccMessageNewLocalServiceUtil} to access the occ message new local service. Add custom service methods to {@link OCCModuleNew.service.impl.OccMessageNewLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OccMessageNew addOccMessageNew(OccMessageNew occMessageNew);
	...
	*/
	public OccMessageNew createOccMessageNew(long MSG_ID);
	...
	*/
	...
	public OccMessageNew deleteOccMessageNew(OccMessageNew occMessageNew);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OccMessageNew deleteOccMessageNew(long MSG_ID)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OccMessageNew fetchOccMessageNew(long MSG_ID);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OccMessageNew getOccMessageNew(long MSG_ID)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OccMessageNew updateOccMessageNew(OccMessageNew occMessageNew);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OccMessageNew> getMsgList(java.lang.String listName);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OccMessageNew> getOccMessageNews(int start, int end);
