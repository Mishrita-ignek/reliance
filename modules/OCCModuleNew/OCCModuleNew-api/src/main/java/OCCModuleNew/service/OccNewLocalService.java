...
/**
 * Provides the local service interface for OccNew. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mukesh Patidar
 * @see OccNewLocalServiceUtil
...
public interface OccNewLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OccNewLocalServiceUtil} to access the occ new local service. Add custom service methods to {@link OCCModuleNew.service.impl.OccNewLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OccNew> getList(java.lang.String listName);
