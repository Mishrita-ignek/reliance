package com.rpower.unpaid.unclaimed.divident.portlet;


import com.rpower.unpaid.unclaimed.divident.constants.RpowerUnpaidUnclaimedDividentWebPortletKeys;
...
import com.rinfra.unpaid.unclaimed.devidend.service.RpowerUnpaidUnclaimedDevidendLocalServiceUtil;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Rpower-UnpaidUnclaimedDivident-web Portlet",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + RpowerUnpaidUnclaimedDividentWebPortletKeys.RpowerUnpaidUnclaimedDividentWeb,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class RpowerUnpaidUnclaimedDividentWebPortlet extends MVCPortlet {
	...
	public void getUnpaidDividendHolders(ActionRequest actionRequest, ActionResponse actionResponse) {
		try {
			System.out.println("In getUnpaidDividendHolders");
			...
			System.out.println("searchInputParam-----2022-----" + FOLIO_NO_OF_ITIES);
			List<RpowerUnpaidUnclaimedDevidend> unpaidUnclaimedDevidendRecords = RpowerUnpaidUnclaimedDevidendLocalServiceUtil.getUnpaidUnclaimedDevidendDataNew(FOLIO_NO_OF_ITIES);
			...
			if ((Validator.isNotNull(unpaidUnclaimedDevidendRecords)) && (!unpaidUnclaimedDevidendRecords.isEmpty())) {
				for (RpowerUnpaidUnclaimedDevidend _unpaidUnclaimedDevidends : unpaidUnclaimedDevidendRecords) {
