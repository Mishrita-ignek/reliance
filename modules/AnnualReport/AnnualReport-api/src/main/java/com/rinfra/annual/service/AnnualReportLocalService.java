...
/**
 * Provides the local service interface for AnnualReport. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MukeshPatidar
 * @see AnnualReportLocalServiceUtil
...
public interface AnnualReportLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnnualReportLocalServiceUtil} to access the annual report local service. Add custom service methods to {@link com.rinfra.annual.service.impl.AnnualReportLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AnnualReport> getAnnualReport(java.lang.String year);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Set<java.lang.String> getAnnualReport();
