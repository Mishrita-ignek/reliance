...
/**
 * Provides the local service interface for unpaidUnclaimedDevidend. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mukesh Patidar
 * @see unpaidUnclaimedDevidendLocalServiceUtil
...
public interface unpaidUnclaimedDevidendLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link unpaidUnclaimedDevidendLocalServiceUtil} to access the unpaid unclaimed devidend local service. Add custom service methods to {@link com.rinfra.unpaidunclaimedshares.service.impl.unpaidUnclaimedDevidendLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<unpaidUnclaimedDevidend> findByfolioNo(
		java.lang.String FOLIO_NO);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<unpaidUnclaimedDevidend> getFolioDetails(
		java.lang.String FOLIO_NO);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<unpaidUnclaimedDevidend> getFolioDetailsCustomSql(
		java.lang.String FOLIO_NO);
