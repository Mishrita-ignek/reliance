...
/**
 * This class is used by SOAP remote services, specifically {@link com.unpaid.unclaimed.dividend.holders.service.http.UnpaidUnclaimedDevidendHoldersServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see com.unpaid.unclaimed.dividend.holders.service.http.UnpaidUnclaimedDevidendHoldersServiceSoap
 * @generated
 */
@ProviderType
public class UnpaidUnclaimedDevidendHoldersSoap implements Serializable {
	public static UnpaidUnclaimedDevidendHoldersSoap toSoapModel(
		UnpaidUnclaimedDevidendHolders model) {
		UnpaidUnclaimedDevidendHoldersSoap soapModel = new UnpaidUnclaimedDevidendHoldersSoap();
	...
	public static UnpaidUnclaimedDevidendHoldersSoap[] toSoapModels(
		UnpaidUnclaimedDevidendHolders[] models) {
		UnpaidUnclaimedDevidendHoldersSoap[] soapModels = new UnpaidUnclaimedDevidendHoldersSoap[models.length];
	...
	public static UnpaidUnclaimedDevidendHoldersSoap[][] toSoapModels(
		UnpaidUnclaimedDevidendHolders[][] models) {
		UnpaidUnclaimedDevidendHoldersSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new UnpaidUnclaimedDevidendHoldersSoap[models.length][models[0].length];
		}
		else {
			soapModels = new UnpaidUnclaimedDevidendHoldersSoap[0][0];
		}
	...
	public static UnpaidUnclaimedDevidendHoldersSoap[] toSoapModels(
		List<UnpaidUnclaimedDevidendHolders> models) {
		List<UnpaidUnclaimedDevidendHoldersSoap> soapModels = new ArrayList<UnpaidUnclaimedDevidendHoldersSoap>(models.size());

		for (UnpaidUnclaimedDevidendHolders model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new UnpaidUnclaimedDevidendHoldersSoap[soapModels.size()]);
	}

	public UnpaidUnclaimedDevidendHoldersSoap() {
	}
