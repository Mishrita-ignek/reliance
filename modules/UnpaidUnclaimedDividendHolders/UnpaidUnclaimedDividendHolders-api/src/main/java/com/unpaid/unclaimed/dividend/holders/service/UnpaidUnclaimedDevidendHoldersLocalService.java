...
/**
 * Provides the local service interface for UnpaidUnclaimedDevidendHolders. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UnpaidUnclaimedDevidendHoldersLocalServiceUtil
...
public interface UnpaidUnclaimedDevidendHoldersLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UnpaidUnclaimedDevidendHoldersLocalServiceUtil} to access the unpaid unclaimed devidend holders local service. Add custom service methods to {@link com.unpaid.unclaimed.dividend.holders.service.impl.UnpaidUnclaimedDevidendHoldersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UnpaidUnclaimedDevidendHolders> getUnpaidUnclaimedDevidendData(
		java.lang.String FOLIO_NO_OF_ITIES);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UnpaidUnclaimedDevidendHolders> getUnpaidUnclaimedDevidendHolderData(
		java.lang.String FOLIO_NO_OF_ITIES);
